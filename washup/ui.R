             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 conditionalPanel(condition = "input.year5=='L23'",
                                  radioButtons("election5_23", "Election to compare", choices = c("Local 2022"="L22","Local 2021"="L21", "General 2019"="G19", "Local 2019"="L19",  "Local By-election 2022"="B22", "Any Local 19-22"="PrevL23"), selected = "L22", inline = T)),
                 conditionalPanel(condition = "input.year5=='L24'",
                                  radioButtons("election5_24", "Election to compare", choices = c("Local 2023"="L23","Local 2022"="L22","Local 2021"="L21", "General 2019"="G19",  "Local By-election 2022"="B22", "Any Local 21-23"="PrevL23"), selected = "L23", inline = T)),
